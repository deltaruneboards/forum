...
{
	return GetGameInfo($_POST['game_name'], false, 0);
}
...
function ArcadePHPBBHtml(&$game, $auto_start = true)
{
	...
	<script type="text/javascript"><!-- // --><![CDATA[
		...
		function getArcadeUrlParam2(name){
			var qs = (function(a) {
				if (a == "")
					return {};
				var b = {};
		...
		function ArcadeStart()
		{
			...
			var full = getArcadeUrlParam2("pop");
			var flashvars = {};
...
function PHPBB_HTML5()
{
	//log_error('tripped ~ PHPBB-HTML5', 'debug');
}
