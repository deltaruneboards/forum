...
function template_arcade_list()
{
	...
	echo '
		...
		<div class="mobile_title arcade_generic_list_mobile_title arcade_generic_list_header" id="arctoplist">
			<h4 class="centertext arcade_generic_list_mobile_title arcade_generic_list_h4">
				<span class="centertext arcade_generic_list_title"><a href="', $context['sort_link'], '">', $_SESSION['arcade_gametype_select_title'], '</a></span>
			</h4>
		</div>
		<div><span style="display: none;">&nbsp;</span></div>
		<div class="game_table arcade_up_contain arcade_generic_list_upcontain">
			<div translate="no" class="arcade_generic_games_listbox">';
	...
	foreach ($context['arcade']['games'] as $game)
	{
		...
		if (!empty($arcadeModSettings['arcadeDisplayType']) && !empty($txt['arcade_gamesavetype'][$game['submit_system']]) && empty($rom))
			$game_type .= '
							<div><b>&bull;</b>&nbsp;<span class="arcade_generic_list_typeset">'. $txt['arcade_typeset']. '&nbsp;&#058;&nbsp;' .$txt['arcade_gamesavetype'][$game['submit_system']].'</span></div>';
		if (!empty($arcadeModSettings['arcadeRomToggle']) && !empty($arcadeModSettings['arcadeDisplayRomType']) && !empty($txt['arcade_select_gametype_rom'][$game['rom_system']]) && empty($rom))
			$game_type .= '
							<div><b>&bull;</b>&nbsp;<span class="arcade_generic_list_typeset">'. $txt['arcade_romtypeset']. '&nbsp;&#058;&nbsp;' . $txt['arcade_select_gametype_rom'][$game['rom_system']] . '</span></div>';
				...
				$fav .= '
						...
						<span style="padding-left: 0.5em;">
							<a href="'. $game['url']['favorite']. '" onclick="arcade_favorite('. $game['id'] . ');arcade_favorite_text('. $game['id'] . '); return false;">
								<img id="favgame' . $game['id'] . '" src="' . $settings['default_images_url'] . '/arc_icons/star4.gif" class="arcade_generic_list_listicon" alt="' . $txt['arcade_add_favorites'] . '" />' . '
							</a>
						</span>';
			else
				$fav .= '
						...
						<span style="padding-left: 0.5em;">
							<a href="'. $game['url']['favorite']. '" onclick="arcade_favorite('. $game['id'] . ');arcade_favorite_text('. $game['id'] . '); return false;">
								<img id="favgame' . $game['id'] . '" src="' . $settings['default_images_url'] . '/arc_icons/star3.gif" class="arcade_generic_list_listicon" alt="' . $txt['arcade_remove_favorite'] . '" />
							</a>
						</span>';
		}
		...
		$rate = '';
		if ($game['rating2'] > 0)
			$rate = str_repeat('<img class="arcade_generic_list_listicon" src="' . $settings['default_images_url'] . '/arc_icons/arcade_star.gif" alt="*" />' , $game['rating2']) . str_repeat('<img class="arcade_generic_list_listicon" src="' . $settings['default_images_url'] . '/arc_icons/arcade_star2.gif" alt="-" />' , 5 - $game['rating2']);
		else
			$rate = str_repeat('<img class="arcade_generic_list_listicon" src="' . $settings['default_images_url'] . '/arc_icons/arcade_star2.gif" alt="-" />' , 5);
		...
		if ((allowedTo('arcade_admin') == true) && ((int)$game['report_id'] > 0))
		{
			...
			$gamename = '<span class="arcade_generic_list_playlink"><a class="arcadeLinkStyle" href="' . $game['url']['play'] . '" title="' . $txt['alt_play'] . '">' . $game['name'] . ' </a></span>';
		}
		else
		...
		$code .=  '
						<div class="smalltext arcadeListCell arcade_generic_list_cell">
							<div style="display: flex;justify-content: center;flex-direction: row;padding: 0rem !important;" class="cat_bar mobile_title arcadeListTitle arcade_generic_list_mobile_title arcade_generic_list_mobile_box" id="arctoplist' . $game['id'] . '">
								<h3 style="padding-left: 0rem !important;" class="catbg centertext mobileGameLinkH3 arcade_generic_list_mobile_title arcade_generic_list_mobile_boxh3">
									<span class="arcade_generic_list_mobile_titlename">' . $gamename . '</span>
								</h3>
							</div>
							<div class="arcadeGameDescript arcade_generic_list_descript">' . $game['description'] . '</div>
							<div style="height: 1px"></div>
							<div class="smalltext arcadeGameData arcade_generic_list_cat_title">' . (!empty($arcadeModSettings['arcade_showListCat']) ? $cat : '') . '
								...
								<div class="arcade_generic_list_rate"><b>&bull;</b> ' . $rate . '</div>
							</div>
						</div>';
	}
	...
	if (!empty($remainder))
		$code .= str_repeat('
						<div class="smalltext arcadeListCell arcade_generic_list_cell"></div>', $row_tally-$remainder);
	...
	echo '
					...
					<div style="width: 100%;display: flex;">
						<div class="arcade_generic_list_emptycell" style="display: table-cell;"><span style="display: none;">&nbsp;</span></div>
					</div>
				</div>
			</div>
			<span><span>&nbsp;</span></span>
			<div style="width: 100%;position: relative;clear: left;padding-left: 0.3em;">
				<div class="pagesection" style="display: inline;">
					<div class="arcade_generic_list_pages">', $context['page_index'], (!empty($arcadeModSettings['topbottomEnable']) ? $context['menu_separator'] . '&nbsp;&nbsp;<a href="#top"><b>' . $txt['go_up'] . '</b></a>' : ''), '</div>
				</div>
			</div>
			<div class="arcade_generic_list_bottom"><span style="display: none;">&nbsp;</span></div>';

	if (!empty($arcadeModSettings['arcadeShowIC']))
	{
		echo '
			<div class="arcade_generic_list_ic_body">
				<div class="arcadeListRows">
					<div class="arcadeListIC">
						<div id="arctoplistIC" style="display: flex;justify-content: center;flex-direction: row;" class="cat_bar mobile_title arcade_generic_list_mobile_title arcade_generic_list_mobile_box">
							<h3 style="width: 100%;" class="catbg centertext mobileGameLinkH3 arcade_generic_list_mobile_title arcade_generic_list_mobile_boxh3" id="arcade_ic_title">
								<span class="arcade_generic_list_mobile_icname">' . $txt['arcade_info_center'] . '</span>
							</h3>
						</div>
						<div class="arcade_up_contain arcadeGameDescript arcade_generic_list_mobile_ic_start" style="top: 0px;">
							<div class="inline">
		...
		if (!empty($context['arcade']['latest_scores']))
		{
			echo '
									<h4 class="left mobileGameLinkH4" style="padding-top: 0.1rem !important;">
										<span class="arcade_generic_list_mobile_ic_title">', $txt['arcade_latest_scores'], '</span>
									</h4>
									<div class="mediumtext arcadeGameData arcade_generic_list_mobile_ic_ex_box">';
			...
			foreach ($context['arcade']['latest_scores'] as $score)
				echo '
										...
										<div class="arcade_generic_list_mobile_ic_lscores_time">',  $score['time'], '</div>';
		...
		elseif (empty($rom))
			echo '
									...
									<div class="mediumtext arcade_generic_list_mobile_ic_lscores_none arcade_list_noscore">', $txt['arcade_no_scores'], '</div>';

		echo '
									<h4 class="left clear  mobileGameLinkH4 arcade_generic_list_mobile_ic_h4">
										<span class="arcade_generic_list_mobile_ic_title">', $txt['arcade_game_highlights'], '</span>
									</h4>
									<div class="mediumtext arcadeGameData arcade_generic_list_mobile_ic_box">';
		...
		if ($context['arcade']['stats']['longest_champion'] !== false && !empty($context['arcade']['stats']['longest_champion']['member_link']) && !empty($context['arcade']['stats']['longest_champion']['game_link']))
			echo '
										<div class="arcade_generic_list_mobile_ic_padbot">', sprintf($txt['arcade_game_with_longest_champion'], $context['arcade']['stats']['longest_champion']['member_link'], $context['arcade']['stats']['longest_champion']['game_link']), '</div>';

		if ($context['arcade']['stats']['most_played'] !== false && !empty($context['arcade']['stats']['most_played']['link']))
			echo '
										<div class="arcade_generic_list_mobile_ic_padbot">', sprintf($txt['arcade_game_most_played'], $context['arcade']['stats']['most_played']['link']), '</div>';

		if ($context['arcade']['stats']['best_player'] !== false && !empty($context['arcade']['stats']['best_player']['link']))
			echo '
										<div class="arcade_generic_list_mobile_ic_padbot">', sprintf($txt['arcade_game_best_player'], $context['arcade']['stats']['best_player']['link']), '</div>';
		...
		if (!empty($arcadeModSettings['arcadeShowOnline']))
			echo '
								<h4 class="left clear  mobileGameLinkH4 arcade_generic_list_mobile_ic_olh4">
									<span class="arcade_generic_list_mobile_ic_title">', $txt['arcade_users'], '</span>
								</h4>
								<div class="mediumtext arcadeGameData arcade_generic_list_mobile_ic_ex_box">
									<div class="arcade_generic_list_mobile_ic_padbot">' . $context['arcade_online_link'] . '</div>
									<div class="arcade_generic_list_mobile_ic_viewing">' . implode(', ', $context['arcade_viewing']) . '</div>
								</div>';
		...
		echo '
			...
			<span><span>&nbsp;</span></span>
			<div class="arcade_generic_list_mobile_ic_padbotend"><span style="display: none;">&nbsp;</span></div>';
	}
	elseif (!empty($arcadeModSettings['arcadeShowOnline']))
		echo '
			<div class="arcade_generic_list_mobile_ic_olbox">
				<div class="arcadeListRows">
					<div class="arcadeListIC">
						<div style="display: flex;justify-content: center;flex-direction: row;left: 0.1rem !important;right: 0.1rem !important;" class="cat_bar mobile_title arcade_generic_list_mobile_title arcade_generic_list_mobile_box" id="arctoplistIC">
							<h3 style="width: 100%;" class="catbg centertext mobileGameLinkH3 arcade_generic_list_mobile_title arcade_generic_list_mobile_boxh3" id="arcade_ic_title">
								<span class="arcade_generic_list_mobile_icname">' . $txt['arcade_users'] . '</span>
							</h3>
						</div>
						<div class="arcade_up_contain">
							<div class="arcade_generic_list_mobile_viewbox">
								<div class="mediumtext arcadeGameData arcade_generic_list_mobile_view_linkbox">
									<div class="arcade_generic_list_mobile_view_linktitle">' . $context['arcade_online_link'] . '</div>
									<div class="arcade_generic_list_mobile_view_link">' . implode(', ', $context['arcade_viewing']) . '</div>
								</div>
							</div>
						</div>
					</div>
	...
	echo '
		<script>
			...
			{
				arcadeDescriptInit();
				$(".arcade_generic_list_cell").css("max-width", "100%");
				$(".arcade_generic_list_cell").css("min-width", "100%");
				$(".arcade_generic_list_cell").css("flex", "100%");
				$(".arcade_generic_list_cell").css("justify-content", "space-around");
				$(".arcadeListIC").css({"display":"block","margin":"0rem","padding":"0px","width":"100%","max-width":"100%","min-width":"100%","font-size":"medium","font-weight":"900","left":"0rem"});
				...
				$(".arcade_generic_list_listicon").css("width", "' . (!empty($modSettings['sp_portal_mode']) && in_array('EhPortal_log_stats', $hookCheck) ? '1' : '0.75') . 'rem");
				$(".arcade_generic_list_listicon").css("height", "' . (!empty($modSettings['sp_portal_mode']) && in_array('EhPortal_log_stats', $hookCheck) ? '1' : '0.75') . 'rem");
				$(".arcade_generic_list_listicon").css("padding-top", "' . (!empty($modSettings['sp_portal_mode']) && in_array('EhPortal_log_stats', $hookCheck) ? '0.05' : '0.10') . 'rem");
			...
			{
				arcadeDescriptInit();
				$(".arcade_generic_list_cell").css("align-self", "flex-start");
				$(".arcade_generic_list_cell").css("max-width", "50%");
				$(".arcade_generic_list_cell").css("min-width", "50%");
				$(".arcade_generic_list_cell").css("width", "50%");
				$(".arcade_generic_list_cell").css("flex", "1 1 50%");
				$(".arcade_generic_list_cell").css("justify-content", "space-around");
				$(".arcadeListIC").css({"display":"block","margin":"0rem","padding":"0px","width":"100%","max-width":"100%","min-width":"100%","font-size":"medium","font-weight":"900","left":"0rem"});
				$(".arcadeGameData").css("font-size", "large");
				$(".arcadeGameData").css("line-height", "125%");
				$(".arcade_generic_list_listicon").css("width", "0.75rem");
				$(".arcade_generic_list_listicon").css("height", "0.75rem");
				$(".arcade_generic_list_listicon").css("padding-top", "' . (!empty($modSettings['sp_portal_mode']) && in_array('EhPortal_log_stats', $hookCheck) ? '0.025' : '0.05') . 'rem");
			...
			function arcadeDescriptMore(arcadeOrientation = 1) {
				$(".arcade_generic_list_descript").each(function(event){
