...
function loadMemberContext($user, $display_custom_fields = false)
{
	...
	$memberContext[$user] = array(
		...
		'link' => '<a href="' . $scripturl . '?action=profile;u=' . $profile['id_member'] . '" class="group-' . $profile['id_group'] . '" title="' . sprintf($txt['view_profile_of_username'], $profile['real_name']) . '">' . $profile['real_name'] . '</a>',
		'email' => $profile['email_address'],
		'show_email' => !$user_info['is_guest'] && allowedTo('moderate_forum'), // DUMB change: dont show your own email actually
	...
	if ($context['loadMemberContext_set'] != 'minimal')
	{
		...
		$memberContext[$user] += array(
			'username_color' => '<span class="group-' . $profile['id_group'] . '">' . $profile['member_name'] . '</span>',
			'name_color' => '<span ' . 'class="group-' . $profile['id_group'] . '">' . $profile['real_name'] . '</span>',
			'link_color' => '<a href="' . $scripturl . '?action=profile;u=' . $profile['id_member'] . '" title="' . sprintf($txt['view_profile_of_username'], $profile['real_name']) . '" class="group-' . $profile['id_group'] . '">' . $profile['real_name'] . '</a>',
